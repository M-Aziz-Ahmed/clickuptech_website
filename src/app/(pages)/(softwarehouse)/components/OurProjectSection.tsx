    ...
    <div>
      <div className="relative overflow-hidden bg-gray-900 pt-16 pb-32 space-y-24">
        ...
        <motion.h2
          ...
          viewport={{ once: false }}
          className="text-center text-5xl font-[Proxima] custom-tracking font-extrabold mb-2 underline  decoration-secondaryColor underline-offset-8 decoration-2 "
        >
            <span className="text-white">Our  Some</span> {" "}
         <span className="text-secondaryColor"> Projects</span>
        </motion.h2>
          <div className="lg:mx-auto lg:grid lg:max-w-7xl mt-10 lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8 ">
            ...
            <div className="mt-12 sm:mt-16 lg:mt-0">
              <div className="-mr-48 pl-6 md:-mr-16 lg:relative lg:m-0 lg:h-full lg:px-0">
                <Image
                  ...
                  style={{ color: "transparent" }} // Correctly formatted style attribute
            ...
            <div className="mt-12 sm:mt-16 lg:mt-0">
              <div className="-ml-48 pr-6 md:-ml-16 lg:relative lg:m-0 lg:h-full lg:px-0">
                <Image
                  ...
                  style={{ color: "transparent" }} // Correctly formatted style
            ...
            <div className="mt-12 sm:mt-16 lg:mt-0">
              <div className="-mr-48 pl-6 md:-mr-16 lg:relative lg:m-0 lg:h-full lg:px-0">
                <Image
                  ...
                  height={485}
                  className="w-full rounded-xl shadow-2xl ring-1 ring-black ring-opacity-5 lg:absolute lg:left-0 lg:h-full lg:w-auto lg:max-w-none"
                  style={{ color: "transparent" }} // Correct style object syntax
