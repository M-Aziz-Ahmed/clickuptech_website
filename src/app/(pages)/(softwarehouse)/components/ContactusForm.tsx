...
const ContactUs = () => {
  return (
    <section className="text-gray-600 body-font bg-[#F1F9FF] ">
      <form action="https://fabform.io/f/xxxxx" method="post">
        <div
          className="container flex flex-col md:flex-row lg:max-w-5xl w-full px-5 py-12 md:py-24 mx-auto"
          id="contact-form"
        >
          ...
          <div className="md:w-2/3 w-full mt-10 md:mt-0 md:pl-28">
            <h1 className="text-4xl text-black sm:text-4xl font-bold title-font mb-4 font-[Proxima]">
              Submit <span className="text-secondaryColor">Form</span>{" "}
            </h1>
            <div className="p-2 w-full">
              <div className="relative">
                <label
                  htmlFor="name"
                  className="leading-7 py-4 text-sm text-gray-900"
                >
                  Your Name
                </label>
                <input
            ...
            <div className="p-2 w-full">
              <button
                type="submit"
                className="flex items-center justify-center text-white bg-primaryColor hover:bg-secondaryColor transition-colors duration-300 py-3 px-8 rounded-md text-lg shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primaryColor"
              >
                Send Message
