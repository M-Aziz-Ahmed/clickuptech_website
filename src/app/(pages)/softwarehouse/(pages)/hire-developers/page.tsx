                ...
                <svg className="h-[60rem] w-[100rem] flex-none stroke-blue-600 opacity-20" aria-hidden="true">
                    <defs>
                        <pattern id="e9033f3e-f665-41a6-84ef-756f6778e6fe" width="200" height="200" x="50%" y="50%"
                            ...
                            <path d="M.5 200V.5H200"></path>
                        </pattern>
                    </defs>
                    <svg x="50%" y="50%" className="overflow-visible fill-blue-50">
                        <path d="M-300 0h201v201h-201Z M300 200h201v201h-201Z" ></path>
                    </svg>
                    <rect width="100%" height="100%" fill="url(#e9033f3e-f665-41a6-84ef-756f6778e6fe)">
                    </rect>
                </svg>
            </div>
        </div>
        <div className="relative z-20 mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
                <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
                    Hire  Our Dedicated 
                    <span className="text-blue-600"> Software Developers
               </span>
                </h1>
                <h2 className="mt-6 text-lg leading-8 text-gray-600">
                   Start your dream projects within next 48 hours. And hire our expert developers for your business.
                   Our developers are well trained and experienced. 
                </h2>
