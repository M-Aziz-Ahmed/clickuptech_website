...
export default function WhyChooseInstitude() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-t from-[#1F419B] to-[#1F419B] py-8 sm:py-16">
            ...
            <div className="lg:max-w-lg">
              ...
              <p className="mt-6 text-lg leading-8 text-white">We&apos;ve built an API that al lows you to scale your podcast
                production workflow.
                  ...
                  <dt className="inline font-semibold text-secondaryColor "><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                    fill="currentColor" aria-hidden="true" className="absolute left-1 top-1 h-5 w-5 text-white">
                    <path
                ...
                <div className="relative pl-9">
                  <dt className="inline font-semibold text-secondaryColor">
