...
export default function InstitudeHeader() {
  ...
  return (
    <>
      <div className="hidden font-[Proxima] lg:flex px-[12vw] justify-between items-center mx-2 text-white bg-slate-800">
      ...
      <header className="font-[Proxima] header fixed shadow-sm m-2 mt-0 rounded-b-lg tracking-wide top-0 text-lg bg-gradient-to-t from-[#1F419B] to-[#1F419B]">
        ...
        <section className="flex items-center justify-between gap-4 py-3 px-4 lg:px-10">
          ...
          <div className="flex items-center gap-3 text-white">
            ...
            <Link href="/" className="flex gap-3">
              <div className="h5">DigiSukool IT - Institute</div>
            </Link>
          </div>
          {/* Mobile Menu Toggle */}
